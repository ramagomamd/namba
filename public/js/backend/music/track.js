...
/***/ "./resources/assets/js/backend/track.js":
...
var app = new Vue({
  ...
  methods: {
    ...
    addFeature: function addFeature(newFeature) {
      this.track.features.push(newFeature);
      this.artists.push(newFeature);
    },
    addProducer: function addProducer(newProducer) {
  ...
  mounted: function mounted() {
    ...
    _.filter(getTrackArtists, function (artist) {
      _this2.track.artists.push(artist.name);
    });
    _.filter(getTrackFeatures, function (feature) {
      _this2.track.features.push(feature.name);
    });
  ...
  computed: {
    isFormDirty: function isFormDirty() {
      ...
      return Object.keys(this.fields).some(function (key) {
        return _this3.fields[key].dirty;
      });
    },
    isFormInvalid: function isFormInvalid() {
      ...
      return Object.keys(this.fields).some(function (key) {
        return _this4.fields[key].invalid;
      });
    }
  },
  components: {
...
module.exports = __webpack_require__("./resources/assets/js/backend/track.js");
